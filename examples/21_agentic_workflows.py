"""Example 21: Simple planner/executor agent loop."""
...
def main(prompt: str = "Explain agentic workflows in Python with one practical tip.") -> None:
    """Simple planner/executor agent loop."""
    setup_logging()
