"""Example 02: Send your first Claude API request.
...
def main(prompt: str = "Explain first claude request in Python with one practical tip.") -> None:
    """Send your first Claude API request."""
    setup_logging()
