"""Example 14: Request strict JSON output and parse it.
...
def main(prompt: str = "Explain json mode in Python with one practical tip.") -> None:
    """Request strict JSON output and parse it."""
    setup_logging()
