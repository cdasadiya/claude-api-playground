"""Example 20: Conversation manager with turn limits."""
...
def main(prompt: str = "Explain conversation manager in Python with one practical tip.") -> None:
    """Conversation manager with turn limits."""
    setup_logging()
