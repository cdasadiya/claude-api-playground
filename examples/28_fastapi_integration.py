"""Example 28: Run Claude behind FastAPI endpoint.
...
def main(prompt: str = "Explain fastapi integration in Python with one practical tip.") -> None:
    """Run Claude behind FastAPI endpoint."""
    setup_logging()
