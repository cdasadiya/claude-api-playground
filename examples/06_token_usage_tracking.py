"""Example 06: Show token usage accounting pattern.
...
def main(prompt: str = "Explain token usage tracking in Python with one practical tip.") -> None:
    """Show token usage accounting pattern."""
    setup_logging()
