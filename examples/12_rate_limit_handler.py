"""Example 12: Handle rate-limit backoff strategy.
...
def main(prompt: str = "Explain rate limit handler in Python with one practical tip.") -> None:
    """Handle rate-limit backoff strategy."""
    setup_logging()
