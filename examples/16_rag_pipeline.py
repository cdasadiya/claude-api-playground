"""Example 16: Minimal retrieval-augmented generation flow.
...
def main(prompt: str = "Explain rag pipeline in Python with one practical tip.") -> None:
    """Minimal retrieval-augmented generation flow."""
    setup_logging()
